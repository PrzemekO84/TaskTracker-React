import {
  ...
  useDirection
} from "./chunk-4HT3BQZ3.js";
import {
  dist_exports as dist_exports4
} from "./chunk-KNUAF7ZL.js";
import {
  Anchor,
  Arrow,
  Branch,
  ...
  useFocusGuards,
  useId
} from "./chunk-DSENEU2N.js";
import {
  dist_exports as dist_exports5,
  usePrevious
} from "./chunk-ZU76TD2Z.js";
import {
  Primitive,
  Root,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React39 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState17 = React39.useState, useEffect21 = React39.useEffect, useLayoutEffect = React39.useLayoutEffect, useDebugValue = React39.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime6.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React6.Children.map(children, (child) => (0, import_jsx_runtime6.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime6.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(Root6, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogTrigger = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime8.jsx)(Trigger3, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
      ...
      WarningProvider,
      {
        ...
        children: (0, import_jsx_runtime8.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime8.jsxs)(
          Content4,
          {
            ...
            children: [
              (0, import_jsx_runtime8.jsx)(Slottable3, { children }),
...
var NAME4 = "Label";
var Label3 = React13.forwardRef((props, forwardedRef) => {
...
var Form = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React14.useState({});
    const getFieldValidity = React14.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React14.useCallback(
    ...
    const handleFieldValiditionClear = React14.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React14.useState({});
    const getFieldCustomMatcherEntries = React14.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React14.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React14.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React14.useState({});
    const getFieldCustomErrors = React14.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React14.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React14.useState({});
    const handleFieldMessageIdAdd = React14.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React14.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React14.useCallback(
...
var FormControl = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React14.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React14.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React14.forwardRef(
  (props, forwardedRef) => {
...
var FormBuiltInMessage = React14.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React14.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React14.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React14.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React14.forwardRef(
  (props, forwardedRef) => {
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React15.useRef(false);
  const isPointerDownOnContentRef = React15.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  const handleDismiss = React15.useCallback(() => setOpen(false), [setOpen]);
  React15.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React15.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardPortal = (props) => {
  ...
  return (0, import_jsx_runtime15.jsx)(PortalProvider2, { scope: __scopeHoverCard, forceMount, children: (0, import_jsx_runtime15.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime15.jsx)(Portal, { asChild: true, container, children }) }) });
};
HoverCardPortal.displayName = PORTAL_NAME4;
var CONTENT_NAME6 = "HoverCardContent";
var HoverCardContent = React15.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React15.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React15.useState(false);
  React15.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React15.forwardRef(
  (props, forwardedRef) => {
...
var NAME5 = "Label";
var Label5 = React16.forwardRef((props, forwardedRef) => {
...
var Menubar = React17.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React17.useState(null);
    return (0, import_jsx_runtime17.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React17.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React17.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React17.useCallback(
          (value2) => {
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime17.jsx)(Collection2.Provider, { scope: __scopeMenubar, children: (0, import_jsx_runtime17.jsx)(Collection2.Slot, { scope: __scopeMenubar, children: (0, import_jsx_runtime17.jsx)(
          Root3,
          {
            asChild: true,
            ...
            children: (0, import_jsx_runtime17.jsx)(Primitive.div, { role: "menubar", ...menubarProps, ref: forwardedRef })
          }
        ) }) })
      }
    );
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React17.useRef(false);
...
var MenubarTrigger = React17.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime17.jsx)(Collection2.ItemSlot, { scope: __scopeMenubar, value: menuContext.value, disabled, children: (0, import_jsx_runtime17.jsx)(
      Item,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        children: (0, import_jsx_runtime17.jsx)(Anchor2, { asChild: true, ...menuScope, children: (0, import_jsx_runtime17.jsx)(
          Primitive.button,
          {
            type: "button",
            role: "menuitem",
...
var MenubarGroup = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItem = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React17.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React17.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React17.forwardRef(
  (props, forwardedRef) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(
      NavigationMenuProvider,
      {
        ...
        onItemDismiss: () => setValue(""),
        children: (0, import_jsx_runtime18.jsx)(Primitive.div, { "data-orientation": orientation, ...subProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuProvider = (props) => {
  ...
  return (0, import_jsx_runtime18.jsx)(
    NavigationMenuProviderImpl,
    {
      ...
      children: (0, import_jsx_runtime18.jsx)(Collection3.Provider, { scope, children: (0, import_jsx_runtime18.jsx)(ViewportContentProvider, { scope, items: viewportContent, children }) })
    }
  );
};
...
var NavigationMenuList = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    const list = (0, import_jsx_runtime18.jsx)(Primitive.ul, { "data-orientation": context.orientation, ...listProps, ref: forwardedRef });
    return (0, import_jsx_runtime18.jsx)(Primitive.div, { style: { position: "relative" }, ref: context.onIndicatorTrackChange, children: (0, import_jsx_runtime18.jsx)(Collection3.Slot, { scope: __scopeNavigationMenu, children: context.isRootMenu ? (0, import_jsx_runtime18.jsx)(FocusGroup, { asChild: true, children: list }) : list }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(
      NavigationMenuItemContextProvider,
      {
        ...
        children: (0, import_jsx_runtime18.jsx)(Primitive.li, { ...itemProps, ref: forwardedRef })
      }
    );
  }
);
...
var NavigationMenuTrigger = React18.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
    (0, import_jsx_runtime18.jsx)(Collection3.ItemSlot, { scope: __scopeNavigationMenu, value: itemContext.value, children: (0, import_jsx_runtime18.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime18.jsx)(
      Primitive.button,
      {
        id: triggerId,
        disabled,
    ...
    open && (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      ...
      context.viewport && (0, import_jsx_runtime18.jsx)("span", { "aria-owns": contentId })
    ] })
  ] });
});
...
var NavigationMenuLink = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(FocusGroupItem, { asChild: true, children: (0, import_jsx_runtime18.jsx)(
      Primitive.a,
      {
...
var NavigationMenuIndicator = React18.forwardRef((props, forwardedRef) => {
  ...
  return context.indicatorTrack ? import_react_dom.default.createPortal(
    (0, import_jsx_runtime18.jsx)(Presence, { present: forceMount || isVisible, children: (0, import_jsx_runtime18.jsx)(NavigationMenuIndicatorImpl, { ...indicatorProps, ref: forwardedRef }) }),
...
var NavigationMenuIndicatorImpl = React18.forwardRef((props, forwardedRef) => {
  ...
  return position ? (0, import_jsx_runtime18.jsx)(
    Primitive.div,
    {
      "aria-hidden": true,
...
var NavigationMenuContent = React18.forwardRef((props, forwardedRef) => {
  ...
  return !context.viewport ? (0, import_jsx_runtime18.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime18.jsx)(
  ...
  ) }) : (0, import_jsx_runtime18.jsx)(ViewportContentMounter, { forceMount, ...commonProps, ref: composedRefs });
});
...
var NavigationMenuContentImpl = React18.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime18.jsx)(FocusGroup, { asChild: true, children: (0, import_jsx_runtime18.jsx)(
    DismissableLayer,
    {
      id: contentId,
...
var NavigationMenuViewport = React18.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime18.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime18.jsx)(NavigationMenuViewportImpl, { ...viewportProps, ref: forwardedRef }) });
});
  ...
  return (0, import_jsx_runtime18.jsx)(
    Primitive.div,
    {
      ...
      children: Array.from(viewportContentContext.items).map(([value, { ref, forceMount, ...props2 }]) => {
        ...
        return (0, import_jsx_runtime18.jsx)(Presence, { present: forceMount || isActive, children: (0, import_jsx_runtime18.jsx)(
          NavigationMenuContentImpl,
          {
            ...props2,
...
var FocusGroup = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(FocusGroupCollection.Provider, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime18.jsx)(FocusGroupCollection.Slot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime18.jsx)(Primitive.div, { dir: context.dir, ...groupProps, ref: forwardedRef }) }) });
  }
);
...
var FocusGroupItem = React18.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(FocusGroupCollection.ItemSlot, { scope: __scopeNavigationMenu, children: (0, import_jsx_runtime18.jsx)(
      Primitive.button,
      {
        ...groupProps,
        ref: forwardedRef,
...
var OneTimePasswordField = React19.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React19.useCallback(
      (value2) => {
    ...
    const controlledValue = React19.useMemo(() => {
    ...
    const validationTypeRef = React19.useRef(validation);
    React19.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React19.useRef(null);
    const userActionRef = React19.useRef(null);
    ...
    const locateForm = React19.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React19.useCallback(() => {
    ...
    const valueRef = React19.useRef(currentValue);
    ...
    return (0, import_jsx_runtime19.jsx)(
      OneTimePasswordFieldContext,
      {
        ...
        isHydrated,
        sanitizeValue,
        children: (0, import_jsx_runtime19.jsx)(Collection4.Provider, { scope: __scopeOneTimePasswordField, state: collectionState, children: (0, import_jsx_runtime19.jsx)(Collection4.Slot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime19.jsx)(
          Root3,
          {
            asChild: true,
            ...rovingFocusGroupScope,
...
var OneTimePasswordFieldHiddenInput = React19.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React19.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React19.useState(null);
  ...
  const keyboardActionTimeoutRef = React19.useRef(null);
  React19.useEffect(() => {
    return () => {
  ...
  return (0, import_jsx_runtime19.jsx)(Collection4.ItemSlot, { scope: __scopeOneTimePasswordField, children: (0, import_jsx_runtime19.jsx)(
    Item,
    {
      ...rovingFocusGroupScope,
      asChild: true,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React20.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React20.useCallback(
  ...
  const focusState = React20.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React20.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React20.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React20.useState(void 0);
...
var PasswordToggleFieldIcon = React20.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
    ...
    return (0, import_jsx_runtime20.jsx)(Primitive.svg, { ...domProps, ref: forwardedRef, "aria-hidden": true, asChild: true, children: visible ? visibleIcon : hiddenIcon });
  }
);
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React26.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime25.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React26.isValidElement(newElement) ? React26.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React30.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime29.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React30.isValidElement(newElement) ? React30.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var ToolbarButton = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime35.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime35.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
...
var ToolbarLink = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope6(__scopeToolbar);
    return (0, import_jsx_runtime35.jsx)(Item, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime35.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleItem = React36.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime35.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React37.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime36.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React37.isValidElement(newElement) ? React37.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Tooltip = (props) => {
  ...
  return (0, import_jsx_runtime37.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime37.jsx)(
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime37.jsx)(PortalProvider3, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime37.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime37.jsx)(Portal, { asChild: true, container, children }) }) });
};
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime37.jsxs)(
          Content,
          {
            ...
            children: [
              (0, import_jsx_runtime37.jsx)(Slottable7, { children }),
              (0, import_jsx_runtime37.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime37.jsx)(Root4, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime37.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
